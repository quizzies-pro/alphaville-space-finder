              ...
              <table className="text-sm" style={{ minWidth: "1400px", width: "100%" }}>
                <thead>
                  <tr className="border-b border-border bg-card">
                    ...
                    <th className="text-left px-8 py-4 text-xs tracking-[0.15em] uppercase text-muted-foreground font-medium whitespace-nowrap">Ação</th>
                  </tr>
                </thead>
                <tbody>
                  {leads.map((lead) => (
                      ...
                      <td className="px-8 py-5">
                        <div className="flex items-center gap-4">
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 text-xs tracking-[0.1em] uppercase text-primary hover:text-primary/80 transition-colors whitespace-nowrap"
                          >
